...
const ContactSection = () => {
  ...
  return (
    <section className="py-16 md:py-24 px-6 lg:px-10 bg-pastel-purple" id="contact">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="font-serif text-4xl md:text-5xl font-bold mb-4">Contact Us</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Have questions about our brands or products? Feel free to reach out to us.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea 
                  ...
                  rows={5} 
                  required 
                  className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-black focus:border-black resize-none" 
                />
              </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 mb-2">123 Fashion Avenue</p>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-2">Email: info@hrapparel.com</p>
              <p className="text-gray-600 mb-2">Phone: +1 (555) 123-4567</p>
              <p className="text-gray-600">Hours: Mon-Fri: 9am-6pm</p>
            </div>
            
            <div>
              <h3 className="font-serif text-2xl font-bold mb-4">Connect With Us</h3>
