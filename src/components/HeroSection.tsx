  ...
  return (
    <section className="relative py-20 md:py-28 lg:py-36 bg-white text-center px-4">
      <div className="max-w-5xl mx-auto space-y-3">
        <h2 className="font-serif text-xl sm:text-2xl md:text-3xl tracking-wider animate-fade-in">
          Welcome to
        </h2>
        ...
        <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tighter animate-fade-in" style={{ animationDelay: '0.6s' }}>
          H R Apparel
        </h1>
